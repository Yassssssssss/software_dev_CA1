...
public class CardGameTest {
    ...
    public void testGetNumPlayers()
        ...
        Method getNumPlayers = CardGame.class.getDeclaredMethod("getNumPlayers",
                new Class[] { UserInputsInterface.class, boolean.class });
        ...
        assertEquals(-2147483648,
                getNumPlayers.invoke(cardGame, new Object[] { new MockUserInputs(-2147483648, "_"), true }));
        assertEquals(2147483647,
                getNumPlayers.invoke(cardGame, new Object[] { new MockUserInputs(2147483647, "_"), true }));
    ...
    public void testGetPackFromFile() throws NoSuchMethodException, SecurityException, IllegalAccessException,
        ...
        Method getPackFromFile = CardGame.class.getDeclaredMethod("getPackFromFile",
                new Class[] { UserInputsInterface.class, boolean.class });
        ...
        ArrayList<Card> actualPack = (ArrayList<Card>) getPackFromFile.invoke(cardGame,
                new Object[] { validMockInputs, true });
